...
# Solver for http://projecteuler.net/problem=54
class Problem54 < Problem
  def solve
    @card_values = Hash.new { |h, k| h[k] = k.to_i if ("2".."9").include?(k) }.
  ...
  def hand_value(hand) # rubocop:disable MethodLength, CyclomaticComplexity
...
puts Problem54.solution if $PROGRAM_NAME == __FILE__
